...
<MetaResultFile creator="FE Port mode solver" version="20170330">
  ...
  <SimulationProperties dB_Amplitude="20" encoded_unit="&amp;U:A^1.:m^-1" fieldname="&lt;name missing&gt;" fieldtype="H-Field" frequency="0" label="Zmax In h14"/>
  <MetaGeometryFile filename="" lod="1"/>
  <ResultGroups num_steps="1">
    <Frame index="0" characteristic="10" tfo="Port2_h14_pmm_10.tfo">
      <FieldResultFile filename="Port2_h14(#0000).sct" meshname="Port2.slim" type="sct"/>
    </Frame>
  </ResultGroups>
