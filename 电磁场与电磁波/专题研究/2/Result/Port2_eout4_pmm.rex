...
<MetaResultFile creator="FE Port mode solver" version="20170330">
  ...
  <SimulationProperties dB_Amplitude="20" encoded_unit="&amp;U:V^1.:m^-1" fieldname="&lt;name missing&gt;" fieldtype="E-Field" frequency="0" label="Zmax Out e4"/>
  <MetaGeometryFile filename="" lod="1"/>
  <ResultGroups num_steps="1">
    <Frame index="0" characteristic="10" tfo="Port2_eout4_pmm_10.tfo">
      <FieldResultFile filename="Port2_eout4(#0000).sct" meshname="Port2.slim" type="sct"/>
    </Frame>
  </ResultGroups>
