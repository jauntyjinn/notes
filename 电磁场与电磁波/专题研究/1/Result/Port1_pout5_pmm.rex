...
<MetaResultFile creator="FE Port mode solver" version="20170330">
  ...
  <SimulationProperties dB_Amplitude="10" encoded_unit="&amp;U:V^1.:A^1.:m^-2" fieldname="&lt;name missing&gt;" fieldtype="Powerflow" frequency="0" label="Zmin Out p5"/>
  <MetaGeometryFile filename="" lod="1"/>
  <ResultGroups num_steps="1">
    <Frame index="0" characteristic="10" tfo="Port1_pout5_pmm_10.tfo">
      <FieldResultFile filename="Port1_pout5(#0000).sct" meshname="Port1.slim" type="sct"/>
    </Frame>
  </ResultGroups>
